...
equation
  ...
  annotation(
    Diagram(coordinateSystem(extent = {{-280, -220}, {260, 240}}), graphics = {Text(extent = {{-222, 186}, {166, 148}}, lineColor = {28, 108, 200}, horizontalAlignment = TextAlignment.Left, textString = "Data Set 3.1
