...
/*
  ...
  annotation(
    ...
    Icon(coordinateSystem(grid = {0, 0}, initialScale = 0.1), graphics = {Ellipse(extent = {{-48, 50}, {48, -50}}, endAngle = 360), Line(origin = {-69, 0}, points = {{-21, 0}, {21, 0}}), Line(origin = {69, 0}, points = {{-21, 0}, {21, 0}}), Text(extent = {{-180, 100}, {180, 60}}, textString = "%name", lineColor = {102, 44, 145}), Line(points = {{11, -18}, {3, -16}, {-3, -14}, {-8, -9}, {-12, -1}, {-10, 7}, {-4, 13}, {4, 17}, {11, 18}}, color = {0, 0, 0}, origin = {-11, -18}, rotation = 360, smooth = Smooth.Bezier), Line(points = {{11, -18}, {3, -16}, {-3, -14}, {-8, -9}, {-12, -1}, {-10, 7}, {-4, 13}, {4, 17}, {11, 18}}, color = {0, 0, 0}, origin = {11, 18}, rotation = 180, smooth = Smooth.Bezier)}),
