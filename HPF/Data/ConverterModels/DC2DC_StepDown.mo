  ...
  record ModelData
    ...
    /*(create dialog sections using annotation)
          Converter characteristics
            - output voltage
        */
    parameter Modelica.Units.SI.Voltage V = 5.0 annotation(
      Dialog(group = "Converter characteristics"));
    /*
          Converter model stuff    
        */
    parameter Real alpha = 1.0 annotation(
      Dialog(group = "Converter efficiency model"));
    parameter Real beta = 1.0 annotation(
      Dialog(group = "Converter efficiency model"));
    parameter Real gamma = 1.0 annotation(
      Dialog(group = "Converter efficiency model"));
    parameter Real Pnom = 1.0 annotation(
      Dialog(group = "PLoss calculations"));
    annotation(
