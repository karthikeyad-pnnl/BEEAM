...
model ToyMdl_IdealTfmr
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl aCDC_EmpMdl annotation(
    Placement(transformation(extent = {{16, -16}, {36, 4}})));
...
equation
  ...
  connect(idealTransformer.pinN_Prim, ground1.pin) annotation(
    Line(points = {{-80, 12}, {-82, 12}, {-82, -8}, {-122, -8}, {-122, -30.75}, {-122, -30.75}}, color = {117, 80, 123}));
  ...
  connect(aCDC_EmpMdl.pin_p, laptop.p) annotation(
    Line(points = {{36, 0}, {74, 0}, {74, -4}}, color = {0, 0, 255}));
  connect(aCDC_EmpMdl.pin_n, laptop.n) annotation(
    Line(points = {{36, -12}, {40, -12}, {40, -14}, {48, -14}, {48, -24}, {74, -24}}, color = {0, 0, 255}));
  connect(aCDC_EmpMdl.hPin_P, idealTransformer.pinP_Sec) annotation(
    Line(points = {{16, 0}, {8, 0}, {8, 20}, {-6, 20}, {-6, 32}, {-60, 32}}, color = {92, 53, 102}));
  connect(aCDC_EmpMdl.hPin_N, ground3.pin) annotation(
    Line(points = {{16, -12}, {12, -12}, {12, -12.75}, {4, -12.75}}, color = {117, 80, 123}));
  annotation(
