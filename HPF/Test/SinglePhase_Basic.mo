...
model SinglePhase_Basic
  ...
  SinglePhase.Components.HarmonicImpedance harmonicImpedance(Rh = {0.5 for i in 1:1:systemDef.numHrm}, Xh = {0 * h for h in systemDef.hrms}) annotation(
    Placement(transformation(extent = {{-2, 10}, {18, 30}})));
equation
  ...
  connect(z1.pin_n, z2.pin_n) annotation(
    Line(points = {{64, 20}, {76, 20}, {76, 0}, {64, 0}}, color = {117, 80, 123}));
  connect(ground1.pin, z2.pin_n) annotation(
    Line(points = {{-44, -4.75}, {76, -4.75}, {76, 0}, {64, 0}}, color = {0, 0, 0}));
  connect(harmonicImpedance.pin_n, z1.pin_p) annotation(
    Line(points = {{18, 20}, {44, 20}}, color = {117, 80, 123}));
  connect(z2.pin_p, z1.pin_p) annotation(
    Line(points = {{44, 0}, {30, 0}, {30, 20}, {44, 20}}, color = {0, 0, 0}));
  connect(harmonicImpedance.pin_p, voltageSource1.pin_p) annotation(
    Line(points = {{-2, 20}, {-44, 20}, {-44, 10}}, color = {0, 0, 0}));
  annotation(
