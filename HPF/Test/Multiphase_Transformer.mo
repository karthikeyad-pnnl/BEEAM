...
equation
  ...
  connect(z.pin_p, d1Y.pinSec_A) annotation(
    Line(points = {{84, 34}, {72, 34}, {72, 33.2}, {-2, 33.2}}, color = {92, 53, 102}));
  connect(d1Y.pinSec_N, ground2.pin) annotation(
    Line(points = {{-2, -5.2}, {6, -5.2}, {6, -56.75}}, color = {117, 80, 123}));
  connect(d1Y.pinSec_C, r2.pin_p) annotation(
    Line(points = {{-2, 7.6}, {72, 7.6}, {72, 2}, {84, 2}}, color = {92, 53, 102}));
  connect(d1Y.pinSec_B, r1.pin_p) annotation(
    Line(points = {{-2, 20.4}, {71.5, 20.4}, {71.5, 18}, {84, 18}}, color = {92, 53, 102}));
  connect(voltageSource.pinP_phC, d1Y.pinPrim_C) annotation(
    Line(points = {{-85.5, 8}, {-43, 8}, {-43, -2}, {-34, -2}}, color = {92, 53, 102}));
  connect(voltageSource.pinP_phA, d1Y.pinPrim_A) annotation(
    Line(points = {{-85.5, 28}, {-52, 28}, {-52, 30}, {-34, 30}}, color = {92, 53, 102}));
  connect(voltageSource.pinP_phB, d1Y.pinPrim_B) annotation(
  ...
  connect(vMsrSec_phA.pin_p, d1Y.pinSec_A) annotation(
  ...
  connect(vMsrSec_phB.pin_p, d1Y.pinSec_B) annotation(
    Line(points = {{44, -22}, {44, -22}, {44, 20}, {-2, 20}, {-2, 20.4}}, color = {92, 53, 102}));
  connect(vMsrSec_pbC.pin_p, d1Y.pinSec_C) annotation(
