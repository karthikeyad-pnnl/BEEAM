...
model DC2DC_converter
  HPF.DC.DC2DC_Converters.StepDown stepDown(modelData = modelData1) annotation(
  ...
  Modelica.Electrical.Analog.Basic.Ground ground1 annotation(
    Placement(visible = true, transformation(extent = {{38, -40}, {58, -20}}, rotation = 0)));
  ...
  Modelica.Electrical.Analog.Sensors.PowerSensor msrPwr_In annotation(
    Placement(visible = true, transformation(extent = {{-36, 10}, {-16, 30}}, rotation = 0)));
  Modelica.Electrical.Analog.Sensors.PowerSensor msrPwr_Out annotation(
    Placement(visible = true, transformation(extent = {{24, 10}, {44, 30}}, rotation = 0)));
