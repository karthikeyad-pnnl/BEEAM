...
package MELs_Models
  model light_lvl1_ckt1A
    inner HPF.SystemDef systemDef(fFund = 60, fs = 5000, hrms = {1, 3, 5, 7, 9, 11, 13}, numPh = 1) annotation(
      Placement(visible = true, transformation(origin = {-80, 82.571}, extent = {{-16, -16}, {16, 11.4286}}, rotation = 0)));
    HPF.SinglePhase.Sources.VoltageSource Vin(start_v_re = {120, 0, 0, 0, 0, 0, 0}, vArg = {0, 0, 0, 0, 0, 0, 0}, vMag = {120, 0, 0, 0, 0, 0, 0}) annotation(
    ...
    /* Load Profiles */
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_zone1_f1(tableOnFile = true, tableName = "l1_zone1_f1", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint) annotation(
      Placement(transformation(extent = {{-56, -94}, {-36, -74}})));
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_zone1_b(tableOnFile = true, tableName = "l1_zone1_b", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_zone2_f1(tableOnFile = true, tableName = "l1_zone2_f1", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_zone3_a1(tableOnFile = true, tableName = "l1_zone3_a1", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_zone3_f1(tableOnFile = true, tableName = "l1_zone3_f1", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_zone4_f1(tableOnFile = true, tableName = "l1_zone4_f1", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_a1(tableOnFile = true, tableName = "l1_core_a1", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_a2(tableOnFile = true, tableName = "l1_core_a2", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_a3(tableOnFile = true, tableName = "l1_core_a3", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_b(tableOnFile = true, tableName = "l1_core_b", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_c(tableOnFile = true, tableName = "l1_core_c", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_d(tableOnFile = true, tableName = "l1_core_d", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_e_h2(tableOnFile = true, tableName = "l1_core_e_h2", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_f1(tableOnFile = true, tableName = "l1_core_f1", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_f2_f3(tableOnFile = true, tableName = "l1_core_f2_f3", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_g(tableOnFile = true, tableName = "l1_core_g", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    Modelica.Blocks.Sources.CombiTimeTable combiTimeTable_l1_core_h1(tableOnFile = true, tableName = "l1_core_h1", fileName = ModelicaServices.ExternalReferences.loadResource("modelica://HPF/Data/load_profiles/Light_Level1.txt"), smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint);
    /* New Load Profile
      ...
      */
    /* Light ckt 1 - A phase*/
    HPF.Cables.NEC_CableModel cable_Light_lvl1_ckt1_A(wireGaugeAC = HPF.Types.WireGaugeAC.gauge_12, length = 16.1) annotation(
      Placement(transformation(extent = {{-16, 20}, {-36, 40}})));
    /* Light Model 25 */
    HPF.Cables.NEC_CableModel cable_light25(wireGaugeAC = HPF.Types.WireGaugeAC.gauge_14, length = 7) annotation(
      Placement(transformation(extent = {{14, 20}, {-6, 40}})));
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_25(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915) annotation(
    ...
    HPF.DC.Variable_DC_Load Light_25 annotation(
      Placement(visible = true, transformation(origin = {67, 29}, extent = {{11, -11}, {-11, 11}}, rotation = 180)));
    /* Light Model 26 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_26(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 27 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_27(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 28 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_28(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 29 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_29(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 30 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_30(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 31 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_31(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 32 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_32(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 37 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_37(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 43 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_43(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 44 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_44(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 61 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_61(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 62 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_62(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 63 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_63(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 64 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_64(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 72 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_72(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 73 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_73(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 81 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_81(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 82 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_82(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 83 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_83(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 84 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_84(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 85 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_85(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 86 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_86(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 87 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_87(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 88 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_88(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 89 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_89(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 90 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_90(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 91 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_91(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 92 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_92(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 100 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_100(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 102 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_102(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 103 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_103(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 105 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_105(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 108 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_108(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 109 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_109(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 110 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_110(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 111 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_111(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 112 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_112(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 113 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_113(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 114 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_114(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 115 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_115(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 116 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_116(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 117 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_117(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 118 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_118(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 119 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_119(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 120 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_120(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 121 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_121(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 122 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_122(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 123 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_123(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 124 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_124(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 125 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_125(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 126 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_126(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 127 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_127(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 128 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_128(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 129 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_129(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 130 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_130(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model
  ...
  equation
    connect(Vin.pin_n, GndAC.pin) annotation(
      Line(points = {{-68, 30}, {-78, 30}, {-78, 32}}, color = {117, 80, 123}));
    connect(Light_Driver_25.hPin_L, cable_light25.pin_p) annotation(
      Line(points = {{24, 30}, {14, 30}}, color = {92, 53, 102}));
    connect(Light_25.p, Light_Driver_25.pin_p) annotation(
      Line(points = {{56, 29}, {52, 29}, {52, 30}, {44, 30}}, color = {0, 0, 255}));
    connect(Light_25.n, GndDC.p) annotation(
      Line(points = {{78, 29}, {82, 29}, {82, 52}, {80, 52}}, color = {0, 0, 255}));
    connect(combiTimeTable_l1_zone3_a1.y[1], Light_25.u) annotation(
      Line(points = {{-35, -84}, {4, -84}, {4, -86}, {67.22, -86}, {67.22, 23.5}}, color = {0, 0, 127}));
    connect(Light_Driver_25.hPin_N, GndAC.pin) annotation(
      Line(points = {{24, 14}, {-78, 14}, {-78, 32}}, color = {117, 80, 123}));
    connect(Light_Driver_25.pin_n, GndDC.p) annotation(
      Line(points = {{44, 14}, {80, 14}, {80, 52}}, color = {0, 0, 255}));
    connect(cable_light25.pin_n, cable_Light_lvl1_ckt1_A.pin_p) annotation(
      Line(points = {{-6, 30}, {-16, 30}}, color = {117, 80, 123}));
/* Light Connections
...
/* Light Connections 115 */
    ...
    connect(cable_Light_lvl1_ckt1_A.pin_n, Vin.pin_p) annotation(
      Line(points = {{-36, 30}, {-48, 30}}, color = {117, 80, 123}));
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false)),
      Diagram(coordinateSystem(preserveAspectRatio = false)),
      experiment(StopTime = 8760, Interval = 0.25, __Dymola_Algorithm = "Dassl"));
  ...
  model light_lvl1_ckt1B
    ...
    /* New Load Profile
      ...
      */
    /* Light ckt 1 - B phase*/
    HPF.Cables.NEC_CableModel cable_Light_lvl1_ckt1_B(wireGaugeAC = HPF.Types.WireGaugeAC.gauge_12, length = 16.1) annotation(
      Placement(transformation(extent = {{-14, -18}, {-34, 2}})));
    /* Light Model 1 */
    HPF.Cables.NEC_CableModel cable_light1(wireGaugeAC = HPF.Types.WireGaugeAC.gauge_14, length = 7) annotation(
      Placement(transformation(extent = {{12, -18}, {-8, 2}})));
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_1(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915) annotation(
    ...
    HPF.DC.Variable_DC_Load Light_1 annotation(
      Placement(visible = true, transformation(origin = {67, -5}, extent = {{11, -11}, {-11, 11}}, rotation = 180)));
    /* Light Model 2 */
    HPF.DC.Variable_DC_Load Light_2;
    HPF.Cables.NEC_CableModel cable_light2(wireGaugeAC = HPF.Types.WireGaugeAC.gauge_14, length = 12);
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_2(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 3 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_3(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 9 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_9(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 10 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_10(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 11 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_11(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 12 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_12(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 45 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_45(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 46 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_46(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 47 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_47(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 48 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_48(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 49 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_49(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 281 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_281(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 282 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_282(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 283 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_283(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 284 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_284(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 285 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_285(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 188 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_188(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.0011881915);
    /* Light Model 13 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_13(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 14 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_14(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 15 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_15(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 17 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_17(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 16 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_16(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 18 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_18(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 19 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_19(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 20 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_20(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 21 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_21(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 22 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_22(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 23 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_23(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 24 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_24(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 96 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_96(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 97 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_97(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 98 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_98(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 99 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_99(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 279 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_279(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 280 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_280(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 33 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_33(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 35 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_35(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 7 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_7(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 8 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_8(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 196 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_196(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 197 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_197(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 198 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_198(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 286 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_286(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 4 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_4(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 5 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_5(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 6 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_6(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 50 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_50(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 51 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_51(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model 52 */
    ...
    HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_52(P_DCmin = 2.25, P_nom = 45, P_stby = 1.047973212, VAC_nom = 120, VDC_nom = 19.5, alpha = 0.334528765, beta = 0.101408771, gamma = 0.001131915);
    /* Light Model
      HPF.DC.Variable_DC_Load Light_2;
      HPF.Cables.NEC_CableModel cable_light2(wireGaugeAC=HPF.Types.WireGaugeAC.gauge_14, length=6.1);
      HPF.PowerConverters.SinglePhase.ACDC_1pRectifierSimple Light_Driver_2(
  ...
  equation
    connect(Vin.pin_n, GndAC.pin) annotation(
      Line(points = {{-68, 30}, {-78, 30}, {-78, 32}}, color = {117, 80, 123}));
    connect(Light_Driver_1.hPin_L, cable_light1.pin_p) annotation(
      Line(points = {{28, -8}, {12, -8}}, color = {92, 53, 102}));
    connect(Light_1.p, Light_Driver_1.pin_p) annotation(
      Line(points = {{56, -5}, {52, -5}, {52, -8}, {48, -8}}, color = {0, 0, 255}));
    connect(Light_1.n, GndDC.p) annotation(
      Line(points = {{78, -5}, {82, -5}, {82, 52}, {80, 52}}, color = {0, 0, 255}));
    connect(combiTimeTable_l1_zone3_a1.y[1], Light_1.u) annotation(
      Line(points = {{-35, -84}, {4, -84}, {4, -86}, {67.22, -86}, {67.22, -10.5}}, color = {0, 0, 127}));
    connect(Light_Driver_1.hPin_N, GndAC.pin) annotation(
      Line(points = {{28, -24}, {-78, -24}, {-78, 32}}, color = {117, 80, 123}));
    connect(Light_Driver_1.pin_n, GndDC.p) annotation(
      Line(points = {{48, -24}, {80, -24}, {80, 52}}, color = {0, 0, 255}));
    connect(cable_light1.pin_n, cable_Light_lvl1_ckt1_B.pin_p) annotation(
      Line(points = {{-8, -8}, {-14, -8}}, color = {117, 80, 123}));
/* Light Connections
...
/* Light Connections 45 */
    ...
    connect(cable_Light_lvl1_ckt1_B.pin_n, Vin.pin_p) annotation(
      Line(points = {{-34, -8}, {-42, -8}, {-42, 30}, {-48, 30}}, color = {117, 80, 123}));
    annotation(
      Icon(coordinateSystem(preserveAspectRatio = false)),
      Diagram(coordinateSystem(preserveAspectRatio = false)),
      experiment(StopTime = 8760, Interval = 0.25, __Dymola_Algorithm = "Dassl"));
