...
model PAE_template
  ...
  inner .HPF.SystemDef systemDef(fs=10e3, hrms={i for i in 1:2:2})
    ...
    .Modelica.Blocks.Sources.CombiTimeTable pv_schedule annotation(Placement(transformation(extent = {{-226.0,92.0},{-206.0,112.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .HPF.Templates.ACload aCload annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {-84.0,-30.0},rotation = 90.0)));
    ...
    .HPF.PowerConverters.ThreePhase.ACDC_3pInverterSimple aCDC_3pInverterSimple annotation(Placement(transformation(extent = {{-10.0,-10.0},{10.0,10.0}},origin = {-80.0,82.0},rotation = 90.0)));
