...
model LoadwStepDown
  ...
  final parameter Boolean hasVariableLoad = Modelica.Math.BooleanVectors.anyTrue(onePort.loadType == fill(HPF.DC.DCLoadTypes.VariableLoad, nLoad));
  replaceable Modelica.Electrical.Analog.Interfaces.TwoPort twoPort constrainedby
...
//     hasVariableLoad = Modelica.Math.BooleanVectors.anyTrue(onePort.loadType == fill(HPF.DC.DCLoadTypes.VariableLoad, nLoad));
    ...
    connect(twoPort.p2,onePort[i].p) annotation(Line(points={{-30,11.3333},{-30,
            19.3333},{28,19.3333},{28,10}},                                                                                                                       color = {0,0,255}));
    connect(twoPort.n2,onePort[i].n) annotation(Line(points={{-30,-8.66667},{-30,
            -14.6667},{28,-14.6667},{28,-10}},                                                                                                                      color = {0,0,255}));
