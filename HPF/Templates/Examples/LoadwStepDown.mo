...
model LoadwStepDown
    ...
    .HPF.Templates.LoadwStepDown loadwStepDown2(redeclare replaceable HPF.DC.DC2DC_Converters.StepDown twoPort,nLoad = 2,redeclare replaceable HPF.DC.DC_Load onePort,hasVariableLoad = false) annotation(Placement(transformation(extent = {{-2.0,-38.0},{18.0,-18.0}},origin = {0.0,0.0},rotation = 0.0)));
equation
    ...
    connect(const.y,loadwStepDown.u[i]) annotation(Line(points = {{-39,60},{-12,60},{-12,24}},color = {0,0,127}));
    end for;
    end if;
