...
model ACConverterwLoads
  ...
  inner SystemDef     systemDef(fs=10e3, hrms={i for i in 1:2:20})
    annotation (Placement(visible = true, transformation(origin={26,78},
      extent = {{-14, -14}, {14, 10}}, rotation = 0)));

  SinglePhase.Components.Ground ground1
    annotation(Placement(visible = true, transformation(origin={-84,-28},
      extent = {{-10, -10}, {10, 10}})));
  ...
  Sources.ThreePhase.VoltageSource voltageSource(
    ...
    annotation(Placement(visible = true, transformation(origin={-84,8},
      extent = {{-10, -10}, {10, 10}})));

  SinglePhase.Components.Ground ground2
    annotation (Placement(visible = true, transformation(origin={-16,-30},
  ...
  Data.Examples.LocalConverter localConverter[nConverters](
    acdcConverter_name={"converter1","converter2","converter3"})
