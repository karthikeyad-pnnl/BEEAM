...
model medoff_model_2
    extends .HPF.Templates.Examples.medoff_template_2(accable_phaseA(wireGaugeAC = HPF.Types.WireGaugeAC.gauge_12,length = 300),accable_phaseB(wireGaugeAC = HPF.Types.WireGaugeAC.gauge_12,length = 300),accable_phaseC(wireGaugeAC = HPF.Types.WireGaugeAC.gauge_12,length = 300),nEC_CableModel2(length = 100),nEC_CableModel3(length = 100),nEC_CableModel4(length = 100),aCload(ac_schedule(smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments,extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint,timeScale = 3600)));
