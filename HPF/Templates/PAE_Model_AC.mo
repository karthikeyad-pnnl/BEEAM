...
model PAE_Model_AC
    ...
    aCDC_3pInverterSimple(alpha = 0.001752083262136904,beta = 0.004968741312147945,gamma = 0.01073438174581216,P_nom = 600,VAC_nom = 660,VDC_nom = 277),
    redeclare replaceable .HPF.Templates.Data.Examples.PAE_AC_disaggregate modelData,gain(k = 0),
