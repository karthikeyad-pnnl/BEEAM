...
model ACConverterwLoads
    ...
    constrainedby .HPF.SinglePhase.Interface.ACDC_ConverterBase annotation (
...
equation
  ...
  connect(pin_p, aCDC_ConverterBase.hPin_P) annotation (Line(points={{-100,0},{
          -70,0},{-70,36},{-40,36}}, color={92,53,102}));
