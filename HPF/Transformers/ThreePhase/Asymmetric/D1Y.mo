...
model D1Y
  ...
  HPF.SinglePhase.Interface.HPin_N pinSec_N(h = systemDef.numHrm) annotation(
    Placement(visible = true, transformation(origin = {100, -120}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -120}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.Transformers.SinglePhase.TModel T1(Rc = Rc[1], Rp = Rp[1], Rs = Rs[1], Xm = Xm[1], Xp = Xp[1], Xs = Xs[1], nomV_prim = VPrimRated, nomV_sec = VSecRated / sqrt(3), phi_prim = 0, phi_sec = 0) annotation(
    Placement(visible = true, transformation(origin = {4, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.Transformers.SinglePhase.TModel T2(Rc = Rc[2], Rp = Rp[2], Rs = Rs[2], Xm = Xm[2], Xp = Xp[2], Xs = Xs[2], nomV_prim = VPrimRated, nomV_sec = VSecRated / sqrt(3), phi_prim = -2.0944, phi_sec = -2.0944) annotation(
    Placement(visible = true, transformation(origin = {4, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.Transformers.SinglePhase.TModel T3(Rc = Rc[3], Rp = Rp[3], Rs = Rs[3], Xm = Xm[3], Xp = Xp[3], Xs = Xs[3], nomV_prim = VPrimRated, nomV_sec = VSecRated / sqrt(3), phi_prim = 2.0944, phi_sec = 2.0944) annotation(
