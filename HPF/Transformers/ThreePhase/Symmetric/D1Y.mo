...
model D1Y
  ...
  HPF.SinglePhase.Interface.HPin_N pinSec_N(h = systemDef.numHrm) annotation(
    Placement(visible = true, transformation(origin = {100, -120}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -120}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.Transformers.SinglePhase.TModel T1(Rc = Rc, Rp = Rp, Rs = Rs, Xm = Xm, Xp = Xp, Xs = Xs, nomV_prim = VPrimRated, nomV_sec = VSecRated / sqrt(3), phi_prim = 0, phi_sec = 0) annotation(
    Placement(visible = true, transformation(origin = {4, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.Transformers.SinglePhase.TModel T2(Rc = Rc, Rp = Rp, Rs = Rs, Xm = Xm, Xp = Xp, Xs = Xs, nomV_prim = VPrimRated, nomV_sec = VSecRated / sqrt(3), phi_prim = -2.0944, phi_sec = -2.0944) annotation(
    Placement(visible = true, transformation(origin = {4, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.Transformers.SinglePhase.TModel T3(Rc = Rc, Rp = Rp, Rs = Rs, Xm = Xm, Xp = Xp, Xs = Xs, nomV_prim = VPrimRated, nomV_sec = VSecRated / sqrt(3), phi_prim = 2.0944, phi_sec = 2.0944) annotation(
